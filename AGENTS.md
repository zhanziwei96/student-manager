...
| 测试说明 | `./tests/README.md` | 测试运行指南、冒烟测试说明、故障排查 |
...
### 10.3 测试变更时必须更新 tests/README.md
**⚠️ 如果测试目录结构或测试方式有变化，必须同步更新 `tests/README.md`：**

| 变更类型 | 需要更新的文档 | 更新内容示例 |
|----------|----------------|--------------|
| 新增测试目录 | tests/README.md | 在"目录结构"章节添加新目录 |
| 新增测试标记 | tests/README.md | 在"测试标记说明"表格添加新标记 |
| 测试运行方式变化 | tests/README.md | 更新"快速开始"章节的命令 |
| 测试依赖变化 | tests/README.md + requirements-test.txt | 更新依赖列表 |
| 新增故障排查 | tests/README.md | 在"故障排查"章节添加新问题 |
| 测试检查清单变化 | tests/README.md | 更新"冒烟测试检查清单" |
...
10. **遗漏 tests/README.md 文档更新**（测试目录/方式变更后必须更新）
