...
const themeOverrides = {
  ...
  Button: {
    ...
    colorPressed: 'rgba(255, 255, 255, 0.05)',
  ...
  Select: {
    color: 'rgba(255, 255, 255, 0.05)',
    colorActive: 'rgba(99, 102, 241, 0.1)',
