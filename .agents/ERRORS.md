...
| 11 | ❌ **禁止未经用户明确同意擅自修改功能或简化需求** | 违背用户意图，破坏预期功能，降低用户信任 |
...
| 2026-03-26 | 测试不通过时删除测试 | **禁止测试不通过时删除测试用例**，应修复问题而非绕过测试 |
| 2026-03-26 | 修改 Vue/TS 文件后未创建或修改测试 | **禁止修改完 Vue/TS 文件后不创建或修改测试**，必须根据当前测试内容选择创建新测试或修改已有测试 |
