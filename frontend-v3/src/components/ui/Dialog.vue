  ...
  >
    ...
    >
      ...
      >
        ...
        <button
          type="button"
          class="absolute right-4 top-4 p-1 min-h-[44px] min-w-[44px] inline-flex items-center justify-center rounded-md text-[#525252] hover:text-black focus:outline-none focus:ring-2 focus:ring-[#3b82f6]/50"
          @click="close"
        >
          <X class="h-4 w-4" />
