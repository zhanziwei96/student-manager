...
class TestUsersAPIEnhanced:
    ...
    def test_update_user_not_found(self, admin_client):
        """测试更新不存在的用户"""
        response = admin_client.put("/api/v1/users/99999", json={
            "name": "不存在的用户"
        })
    ...
    def test_reset_user_password_by_username(self, admin_client, teacher_user):
        """测试通过用户名重置密码"""
        response = admin_client.put("/api/v1/users/teacher1/reset-password", json={
    ...
    def test_reset_user_password_not_found(self, admin_client):
        """测试重置不存在用户的密码"""
        response = admin_client.put("/api/v1/users/notexist/reset-password", json={
    ...
    def test_delete_user_not_found(self, admin_client):
        """测试删除不存在的用户"""
        response = admin_client.delete("/api/v1/users/99999")
